...
/**
  ...
  */
public void init() {
	Button oBoton = new Button ("Open CellNet");
	oBoton.addActionListener (this);
  add(oBoton);
	oBoton = new Button ("Close CellNet");
	oBoton.addActionListener (this);
  add(oBoton);
...
public void actionPerformed (ActionEvent evt) {
	if ("Open CellNet".equals (evt.getActionCommand())) {
		if (!oVM.isShowing()) oVM.setVisible(true);
    }
  else if ("Close CellNet".equals (evt.getActionCommand())) {
...
public String getAppletInfo() {
	return "IPD Network. Version 2021 ©Juan C. Burguillo. e-mail: J.C.Burguillo@uvigo.es, June 2021";
	}
