...
public void vRunLoop() {	
  ...
  omStratPMO = omNewStrat_PMO;												// Updates synchronously the new strats	
...
/**
 	* Set the cluster at the center on the grid
 	*/
...
private void vProduceNewStrat_PMO (int x, int y, Cell oBestNeighbor, double dOwnWeightAux) {
	...
	if (omStratPMO[xN][yN].bClusterStrat)								// Cluster strats are imitated without mutation
		omNewStrat_PMO[x][y] = new Strat_PMO (oClusterStratPMO); // It already includes: bClusterStrat = true
